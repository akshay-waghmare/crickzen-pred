"""
Train WBBL Champion Model v2 (Optimized)
Uses hyperparameter-tuned XGBoost (without calibration - found to be best)
"""
import pandas as pd
import numpy as np
...
def train_wbbl_v2():
    ...
    print("\n" + "="*60)
    print("WBBL MODEL v2 PERFORMANCE")
    print("="*60)
    ...
    print(f"v2 Test Brier: {test_brier:.4f}")
    improvement = (0.1836 - test_brier) / 0.1836 * 100
    print(f"Improvement:   {improvement:.2f}%")
    
    # Save model
    output_dir = 'models/wbbl_champion_v2'
