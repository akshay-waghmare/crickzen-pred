...
**Generated**: 2026-05-01 13:29 UTC  
**Mode**: `pilot`  
...
| `ml_add_mc_win_prob_inn2_only` | 2316 | 0.2272 | 0.1037 | 0.6576 | -0.0053 | -0.0241 | -0.0129 |
| `ml_add_mc_gap_features` | 2316 | 0.2299 | 0.1214 | 0.6646 | -0.0027 | -0.0063 | -0.0059 |
| `ml_add_mc_gap_features_inn2_only` | 2316 | 0.2300 | 0.1215 | 0.6655 | -0.0025 | -0.0062 | -0.0049 |
| `ml_replace_resource_with_mc` | 2316 | 0.2282 | 0.1060 | 0.6588 | -0.0044 | -0.0218 | -0.0117 |
| `ml_replace_resource_with_mc_inn2_only` | 2316 | 0.2281 | 0.1075 | 0.6598 | -0.0044 | -0.0202 | -0.0106 |
| `ml_clean_swap_resource` | 2316 | 0.2293 | 0.1259 | 0.6619 | -0.0033 | -0.0019 | -0.0086 |
| `ml_clean_swap_resource_inn2_only` | 2316 | 0.2299 | 0.1272 | 0.6626 | -0.0026 | -0.0005 | -0.0078 |
...
| `ml_add_mc_win_prob_inn2_only` | innings_1 | 0.2674 | 0.1877 | 0.7548 |
| `ml_add_mc_win_prob_inn2_only` | innings_1_death | 0.2640 | 0.2272 | 0.7520 |
| `ml_add_mc_win_prob_inn2_only` | innings_1_middle | 0.2644 | 0.1974 | 0.7442 |
| `ml_add_mc_win_prob_inn2_only` | innings_1_powerplay | 0.2755 | 0.2261 | 0.7754 |
| `ml_add_mc_win_prob_inn2_only` | innings_2 | 0.1839 | 0.1380 | 0.5527 |
| `ml_add_mc_win_prob_inn2_only` | innings_2_death | 0.1481 | 0.1574 | 0.4605 |
| `ml_add_mc_win_prob_inn2_only` | innings_2_middle | 0.1755 | 0.1593 | 0.5286 |
| `ml_add_mc_win_prob_inn2_only` | innings_2_powerplay | 0.2260 | 0.2110 | 0.6653 |
| `ml_add_mc_win_prob_inn2_only` | overall | 0.2272 | 0.1314 | 0.6576 |
...
| `ml_add_mc_gap_features_inn2_only` | innings_1 | 0.2628 | 0.2052 | 0.7411 |
| `ml_add_mc_gap_features_inn2_only` | innings_1_death | 0.2595 | 0.2510 | 0.7351 |
| `ml_add_mc_gap_features_inn2_only` | innings_1_middle | 0.2613 | 0.2097 | 0.7344 |
| `ml_add_mc_gap_features_inn2_only` | innings_1_powerplay | 0.2687 | 0.2432 | 0.7590 |
| `ml_add_mc_gap_features_inn2_only` | innings_2 | 0.1950 | 0.1547 | 0.5850 |
| `ml_add_mc_gap_features_inn2_only` | innings_2_death | 0.1561 | 0.1600 | 0.4851 |
| `ml_add_mc_gap_features_inn2_only` | innings_2_middle | 0.1875 | 0.1589 | 0.5621 |
| `ml_add_mc_gap_features_inn2_only` | innings_2_powerplay | 0.2382 | 0.2282 | 0.7015 |
| `ml_add_mc_gap_features_inn2_only` | overall | 0.2300 | 0.1463 | 0.6655 |
...
| `ml_replace_resource_with_mc_inn2_only` | innings_1 | 0.2685 | 0.1824 | 0.7569 |
| `ml_replace_resource_with_mc_inn2_only` | innings_1_death | 0.2650 | 0.2219 | 0.7540 |
| `ml_replace_resource_with_mc_inn2_only` | innings_1_middle | 0.2648 | 0.1934 | 0.7449 |
| `ml_replace_resource_with_mc_inn2_only` | innings_1_powerplay | 0.2779 | 0.2343 | 0.7803 |
| `ml_replace_resource_with_mc_inn2_only` | innings_2 | 0.1846 | 0.1441 | 0.5550 |
| `ml_replace_resource_with_mc_inn2_only` | innings_2_death | 0.1453 | 0.1462 | 0.4544 |
| `ml_replace_resource_with_mc_inn2_only` | innings_2_middle | 0.1779 | 0.1568 | 0.5355 |
| `ml_replace_resource_with_mc_inn2_only` | innings_2_powerplay | 0.2266 | 0.2091 | 0.6665 |
| `ml_replace_resource_with_mc_inn2_only` | overall | 0.2281 | 0.1301 | 0.6598 |
...
| `ml_clean_swap_resource_inn2_only` | innings_1 | 0.2633 | 0.2113 | 0.7406 |
| `ml_clean_swap_resource_inn2_only` | innings_1_death | 0.2609 | 0.2588 | 0.7367 |
| `ml_clean_swap_resource_inn2_only` | innings_1_middle | 0.2613 | 0.2164 | 0.7331 |
| `ml_clean_swap_resource_inn2_only` | innings_1_powerplay | 0.2689 | 0.2364 | 0.7577 |
| `ml_clean_swap_resource_inn2_only` | innings_2 | 0.1943 | 0.1562 | 0.5793 |
| `ml_clean_swap_resource_inn2_only` | innings_2_death | 0.1577 | 0.1556 | 0.4833 |
| `ml_clean_swap_resource_inn2_only` | innings_2_middle | 0.1872 | 0.1577 | 0.5585 |
| `ml_clean_swap_resource_inn2_only` | innings_2_powerplay | 0.2349 | 0.2258 | 0.6896 |
| `ml_clean_swap_resource_inn2_only` | overall | 0.2299 | 0.1502 | 0.6626 |
...
| `ml_add_mc_gap_features_inn2_only` | `mc_win_prob` | 0.0855 |
| `ml_add_mc_gap_features_inn2_only` | `mc_simulation_std` | 0.0322 |
| `ml_add_mc_gap_features_inn2_only` | `mc_resource_abs_gap` | 0.0166 |
| `ml_add_mc_gap_features_inn2_only` | `mc_resource_gap` | 0.0074 |
| `ml_add_mc_win_prob` | `mc_win_prob` | 0.1228 |
| `ml_add_mc_win_prob_inn2_only` | `mc_win_prob` | 0.0987 |
...
| `ml_replace_resource_with_mc_inn2_only` | `mc_win_prob` | 0.0823 |
| `ml_replace_resource_with_mc_inn2_only` | `mc_simulation_std` | 0.0287 |
| `ml_replace_resource_with_mc_inn2_only` | `mc_resource_abs_gap` | 0.0138 |
| `ml_replace_resource_with_mc_inn2_only` | `mc_resource_gap` | 0.0097 |
...
- **ml_add_mc_win_prob_inn2_only**: ❌ FAIL
- **ml_add_mc_gap_features**: ❌ FAIL
- **ml_add_mc_gap_features_inn2_only**: ✅ PASS
- **ml_replace_resource_with_mc**: ❌ FAIL
- **ml_replace_resource_with_mc_inn2_only**: ❌ FAIL
- **ml_clean_swap_resource**: ✅ PASS
- **ml_clean_swap_resource_inn2_only**: ✅ PASS

**Failure reasons:**
- [ml_add_mc_win_prob] Segment innings_1_powerplay Brier worsened by +0.0070
- [ml_add_mc_win_prob_inn2_only] Segment innings_1_powerplay Brier worsened by +0.0066
...
- [ml_replace_resource_with_mc_inn2_only] Segment innings_1_powerplay Brier worsened by +0.0090
